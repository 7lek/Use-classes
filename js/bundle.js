...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _srivices_services__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../srivices/services */ "./js/srivices/services.js");
...
/* harmony import */ var _srivices_services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../srivices/services */ "./js/srivices/services.js");
...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            (0,_srivices_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json)
            .then(data => {
                console.log(data);
...
/***/ "./js/srivices/services.js":
/*!*********************************!*\
  !*** ./js/srivices/services.js ***!
  \*********************************/
/***/ (() => {

throw new Error("Module parse failed: Export 'getResource' is not defined (22:7)\nYou may need an appropriate loader to handle this file type, currently no loaders are configured to process this file. See https://webpack.js.org/concepts#loaders\n| \n| export{postData};\n> export{getResource};");
